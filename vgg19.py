...
def VGG19(
    ...
    if include_top:
        ...
        x = layers.ReLU(name="fc1_activation")(x)
        x = layers.Dense(4096, name="fc2")(x)
        x = layers.ReLU(name="fc2_activation")(x)
